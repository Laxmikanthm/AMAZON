...
import com.cigniti.utilities.CleanReports;
...
//System.out.println(configProps.getProperty("screenShotPath") + strDirectoy);
	...
	public void onSuccess(String strStepName, String strStepDes) {
		...
		File file = new File(TestEngine.filePath() + "/" + strTestName + "_Results" + ".html");// "SummaryReport.html"
		Writer writer = null;
		stepNum = stepNum + 1;
	...
	public void closeSummaryReport(String browser) {
		File file = new File(TestEngine.filePath() + "/" + "Summary_Results_" + browser + ".html");// "SummaryReport.html"
		Writer writer = null;
		try {
			writer = new FileWriter(file, true);
