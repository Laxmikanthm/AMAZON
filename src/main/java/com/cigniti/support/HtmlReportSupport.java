...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport(String browser) throws Exception {
		...
		File file = new File(TestEngine.filePath() + "/" + "Summary_Results_"+browser
		...
		try {
			...
			writer.write("<head> ");
			writer.write("<meta charset='UTF-8'> ");
			writer.write("<title>VINCEANDASSOCIATES - Automation Execution Results Summary</title>");
			...
			writer.write("<tr class='content'>");
			writer.write("<th class ='Logos' colspan='2' >");
			/*writer.write("<img align ='left' src= ./Screenshots/" + config.getProperty("logo")
					+ ".png></img>");*/
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");
			writer.write("<img align ='right' src= ./Screenshots/cigniti.png></img>");
			...
			writer.write("<tr class='heading'> ");
			writer.write("<th colspan='4' style='font-family:Copperplate Gothic Bold; font-size:1.4em;'> ");
			writer.write("VINCEANDASSOCIATES -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
			writer.write("<tr class='subheading'> ");
			writer.write("<th>&nbsp;Date&nbsp;&&nbsp;Time&nbsp;:&nbsp;" + ""
			...
			writer.write("<tr class='subheading'> ");
			writer.write("<th colspan='4'> ");
			writer.write("&nbsp;Environment -  " + configProps.getProperty("Environment") + "");
			writer.write("</th> ");
			writer.write("</tr> ");
			writer.write("</thead> ");
			writer.write("</table> ");
	...
	public void testHeader(String testName) {
		...
		try {
			...
			writer.write("<tr class='content'>");
			writer.write("<th class ='Logos' colspan='2' >");
			//writer.write("<img align ='left' src= ./Screenshots/AMAZON.png></img>");
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");			
			writer.write("<img align ='right' src= ./Screenshots/cigniti.png></img>");
			writer.write("</th> ");
